 import* as THREE from "../js/three.module.js";
  ...
  export default function mar3({x,y,z}){
...
var geometry03 = new THREE.BoxGeometry(6.5,8.5,0.5);
    ...
    var texture1 = new THREE.TextureLoader().load("./image/p3.jpeg");
...
var marco3 = new THREE.Group();
   marco3.add(mesh02,mesh03);
   marco3.position.set(x,y,z);
