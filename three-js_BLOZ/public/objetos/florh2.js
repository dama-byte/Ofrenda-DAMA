...
import {RoundedBoxGeometry} from "../js/RoundedBoxGeometry.js"
  ...
  export default function flh2({x,y,z}){
...
var florh2 = new THREE.Group();
   florh2.add(flor1,flor1A,flor2,flor2A,flor3,flor3A,flor4,flor4A,flor5,flor5A,flor6,flor6A,flor7,flor7A);
   florh2.position.set(x,y,z);
