 import* as THREE from "../js/three.module.js";
  ...
  export default function mar2({x,y,z}){
...
var geometry03 = new THREE.BoxGeometry(6.5,8.5,0.5);
    ...
    var texture1 = new THREE.TextureLoader().load("./image/p2.jpeg");
...
var marco2 = new THREE.Group();
   marco2.add(mesh02,mesh03);
   marco2.position.set(x,y,z);
