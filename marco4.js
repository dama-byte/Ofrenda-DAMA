 import* as THREE from "../js/three.module.js";
  ...
  export default function mar4({x,y,z}){
...
var geometry03 = new THREE.BoxGeometry(6.5,8.5,0.5);
    ...
    var texture1 = new THREE.TextureLoader().load("./image/p4.jpeg");
...
var marco4 = new THREE.Group();
   marco4.add(mesh02,mesh03);
   marco4.position.set(x,y,z);
